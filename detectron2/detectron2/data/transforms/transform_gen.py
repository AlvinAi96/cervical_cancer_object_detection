...
#        self._init(locals())
        ...
        # The above commented old codes only implement horizontal flipping.
        # The below new codes can implement both horizontal and vertical flipping.
        horiz, vert = True, True
        # TODO implement vertical flip when we need it
        super().__init__()

        if not horiz and not vert:
            raise ValueError("Both horiz or vert has to be True!")
        self._init(locals())
