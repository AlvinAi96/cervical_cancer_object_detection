...
# Horizontal/Vertical Flipping probability
# - When prob > INPUT.FLIP.PROB, preserve the image
# - When INPUT.FLIP.PROB/2 <= pro < INPUT.FLIP.PROB, implement Vertical Flip
# - When pro < INPUT.FLIP.PROB/2, implement Horizontal FLip
...
_C.INPUT.CONTRAST.INTENSITY_MIN = 0.5
_C.INPUT.CONTRAST.INTENSITY_MAX = 1.5
